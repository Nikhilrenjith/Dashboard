...
const Sidebar = () => {
  return (
    <div className=" px-[25px] h-screen">
      <div className="px-[10px] py-[20px] flex items-center justify-around border-b-[1px] border-[black]/[0.3]">
      ...
      <div className="flex items-center gap-[15px] py-[20px] border-b-[1px] border-[#EDEDED]/[0.3] cursor-pointer">
        <FaTachometerAlt />
        <p className="text-[14px] leading-[20px] ">Dashboard</p>
      </div>
      <div className="pt-[15px] border-b-[1px] border-[#EDEDED]/[0.3]">
        <p className="text-[10px] font-extrabold leading-[16px]/[0.4]">
          {" "}
          INTERFACE
        </p>
        <div className="flex items-center justify-between gap-[10px] py-[15px] cursor-pointer">
          <div className="flex items-center gap-[10px]">
            <FaRegSun />{" "}
            <p className="text-[14px] leading-[20px] font-normal">Components</p>
          </div>
          <FaChevronRight />
        </div>
        <div className="flex items-center justify-between gap-[10px] py-[15px] cursor-pointer">
          <div className="flex items-center gap-[10px]">
            <FaWrench />{" "}
            <p className="text-[14px] leading-[20px] font-normal">Utilities</p>
          </div>
          <FaChevronRight />
        </div>
      </div>
      <div className="pt-[15px] border-b-[1px] border-[#EDEDED]/[0.3]">
        ...
        <div className="flex items-center justify-between gap-[10px] py-[15px] cursor-pointer">
          <div className="flex items-center gap-[10px]">
            <FaStickyNote />{" "}
            <p className="text-[14px] leading-[20px] font-normal">Pages</p>
          </div>
          <FaChevronRight />
        </div>
        <div className="flex items-center gap-[10px] py-[15px] cursor-pointer">
          <FaRegChartBar />{" "}
          <p className="text-[14px] leading-[20px] font-normal">Charts</p>
        </div>
        <div className="flex items-center gap-[10px] py-[15px] cursor-pointer">
          <FaRegCalendarAlt />{" "}
          <p className="text-[14px] leading-[20px] font-normal">Tables</p>
        </div>
      </div>
    </div>
  );
